        ...
        {activeTab === 'memory' && (
          <>
            {memories.length === 0 ? (
              ...
              const typeColor: Record<string, string> = { pattern: '#f97316', recurring: '#ef4444', trend: '#f97316', connection: '#eab308', contrast: '#6a8aaa' };
              const typeIcon:  Record<string, string> = { pattern: '⟳', recurring: '⚡', trend: '↗', connection: '⬡', contrast: '◈' };
              const typeLabel: Record<string, string> = { pattern: 'PATTERN', recurring: 'RECURRING', trend: 'TREND', connection: 'CONNECTION', contrast: 'CONTRAST' };
