...
| --- | --- |
| [`2026-09-16-entree-compacte/`](2026-09-16-entree-compacte/) | Entrée compacte (`input_version` 4) derrière le prompt v8, branche `exp/intelligence-compact-input`, PR en brouillon. −26 % de `prompt_tokens` sur le corpus et sur le lot du 16 ; eval v8 du 16 au soir : 14/14 valides, 3/4 attentes comme v7, 645 s contre 739 s, aucune attente perdue. Attend la lecture des sorties et le verdict de l'utilisateur. |
