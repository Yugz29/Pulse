...
| `prompt_version` | `v6` | reprise bornée à la session, sans annexes ; `v5` reçoit les annexes ; v1–v4 refusent cette entrée. `v6-sans-phrase`, `v6-sans-exemple`, `v6-sans-phrase-ni-exemple` : variantes du rejeu `open` du 2026-09-11 (`docs/dogfooding.md`, jour 7), pas des défauts ; `v7` : la variante complète, en production depuis le 2026-09-12 ([décision](../docs/decisions/2026-09-12-prompt-v7.md)) ; `v8` : expérimental, v7 plus la description de l'entrée compacte (`input_version` 4 : faits `file` en tableau, dates à la seconde, hash abrégé, workspace de session omis), construite pour ce seul prompt ([mesure](../docs/audits/2026-09-16-entree-compacte/README.md)) |
