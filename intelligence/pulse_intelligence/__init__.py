...
# `core/daemon_v2/analysis/timeline.py`, 3 depuis le 2026-09-06, 4 depuis le
# 2026-09-12 : seuil avant split) sur laquelle ce code, ses prompts et ses
# attentes ont été validés. Un daemon qui sert une
...
KNOWN_RECONSTRUCTION_VERSION = 4
