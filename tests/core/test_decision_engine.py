...
class TestDecisionEngine(unittest.TestCase):
    ...
    def test_debug_context_detected(self):
        ...
        self.assertEqual(decision.reason, "debug_context_detected")
    ...
    def test_high_friction_declenche_notification(self):
        ...
        self.assertEqual(decision.action, "notify")
        self.assertEqual(decision.reason, "high_friction")
        self.assertEqual(decision.payload["file"], "/tmp/main.py")
    ...
    def test_idle_longue_session_declenche_resume(self):
        ...
        self.assertEqual(decision.action, "llm")
        self.assertEqual(decision.reason, "session_summary_opportunity")
